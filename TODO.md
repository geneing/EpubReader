...
- [ ] Complete the mini-player and per-book engine/voice selection. (A grace-period library mini-player with play/pause, utterance skip, stop, cover, and progress is implemented; Pocket voices are now discovered dynamically from the model pack and exposed in Settings. Background chapter navigation and per-book speech/voice persistence remain.)
