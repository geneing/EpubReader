...
- [x] Pinned Pocket TTS LiteRT runtime sources to upstream commit `2dba83888706fb52339767670a36ef22348aecd4`, integrated its engine/service modules, added Pocket engine/voice settings, and added cancellable model installation from the pinned `2026.09` manifest.
