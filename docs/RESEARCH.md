...
- Readium: [Kotlin Toolkit](https://github.com/readium/kotlin-toolkit), [latest stable documentation](https://readium.org/kotlin-toolkit/3.3.0/), [navigator capabilities](https://readium.org/kotlin-toolkit/3.3.0/guides/navigator/navigator).
