...
- Readium 3.4.0's [`TtsPlayer`](https://github.com/readium/kotlin-toolkit/blob/3.4.0/readium/navigators/media/tts/src/main/java/org/readium/navigator/media/tts/TtsPlayer.kt) creates TTS audio but does not request or arbitrate Android audio focus. The app-owned playback service must request/abandon focus and apply the resume policy; follow [Android audio focus guidance](https://developer.android.com/media/optimize/audio-focus).
